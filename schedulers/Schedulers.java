...
public class Schedulers {
	...
	static int[] announceAt = { 20, 10, 5, 3, 2, 1 };

	public static void runGameCountdown() {
		...
		activeSchedulerID = Bukkit.getScheduler().scheduleSyncRepeatingTask(DragonGames.INSTANCE, new Runnable() {
			@Override
			public void run() {
	...
	public static void runGraceCountdown() {
	...
	public static void runSpawnCountdown() {
